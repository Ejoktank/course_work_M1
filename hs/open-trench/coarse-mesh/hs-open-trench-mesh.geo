...
Point(23) = {TrenchHeight/4.0 - TrenchWidth,0.0,-TrenchDepth};
Point(24) = {TrenchHeight/4.0,0.0,-TrenchDepth};
Point(25) = {TrenchHeight/4.0,TrenchHeight/2.0,-TrenchDepth};
Point(26) = {TrenchHeight/4.0 - TrenchWidth,TrenchHeight/2.0,-TrenchDepth};
...
Line Loop(13) = {40,-34,-38,9};
Line Loop(14) = {-36,-39,-6,37};
Line Loop(15) = {-40,10,39,-35};
Line Loop(16) = {33,34,35,36};
...
Physical Surface ("FreeSoilSurface",1) = {1:2,4:8};
Physical Surface ("Trench",2) = {13:16};
Physical Surface ("HalfSpaceBound",3) = {9:12};

Transfinite Curve {4,2,6,9,12,20,36,34} = 7;
Transfinite Curve {1,3,18} = 4;
Transfinite Curve {5,7,16,37:40} = 3;
Transfinite Curve {8,10,14,33,35} = 2;
